...
cp -fv "${MANIFEST_ROOT}/operator-squids/clickhouse-operator-install-bundle.yaml"   "${MANIFEST_ROOT}/operator-squids/clickhouse-operator-install-bundle-v1beta1.yaml"
cp -fv "${MANIFEST_ROOT}/operator-squids/clickhouse-operator-install-template.yaml" "${MANIFEST_ROOT}/operator-squids/clickhouse-operator-install-template-v1beta1.yaml"
declare -a ALL_YAML=("${MANIFEST_ROOT}/operator-squids/clickhouse-operator-install-bundle-v1beta1.yaml" "${MANIFEST_ROOT}/operator-squids/clickhouse-operator-install-template-v1beta1.yaml")
